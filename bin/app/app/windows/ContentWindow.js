...
const CONTENT_DIR = path.resolve(path.join(__dirname, '/../../../views/content'))
...
class ContentWindow extends KuniWindow {
  /* ****************************************************************************/
  // Lifecycle
  /* ****************************************************************************/
  ...
  */
  reload () {
    this.window.webContents.send(WINDOW_RELOAD_WEBVIEW, {})
    return this
  }
  ...
  */
  navigateBack () {
    this.window.webContents.send(WINDOW_NAVIGATE_WEBVIEW_BACK, {})
    return this
  }
  ...
  */
  navigateForward () {
    this.window.webContents.send(WINDOW_NAVIGATE_WEBVIEW_FORWARD, {})
    return this
  }
}
