const CoreStream = require('../CoreStream')
const StreamColors = require('../StreamColors')
const GenericDefaultService = require('./GenericDefaultService')

class GenericStream extends CoreStream {
  /* **************************************************************************/
  // Class
  /* **************************************************************************/

  static get type () { return CoreStream.STREAM_TYPES.GENERIC }
  ...
  get color () {
    if (this.usePageThemeAsColor && this.pageThemeColor) {
      ...
      return super.color || StreamColors.GENERIC
    }
  }
