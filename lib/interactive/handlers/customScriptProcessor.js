...
function scriptProcessor(scriptName, buttonName, username) {
  ...
  var scriptsFolder = path.resolve(process.cwd(), 'user-settings'+ path.sep +'scripts');  
...
ipcMain.on('openScriptsFolder', function(event) {
  ...
  var scriptsFolder = path.resolve(process.cwd(), 'user-settings' + path.sep + 'scripts' + path.sep + "fakescript.js");
