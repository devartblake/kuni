...
class AcceleratorSettings extends Model {
  ...
  get composeMessageDefault () { return 'CmdOrCtrl+N' }
  get showWindowDefault () { return 'CmdOrCtrl+Shift+N' }
  get hideWindowDefault () { return 'CmdOrCtrl+N' }
  ...
  get composeMessage () { return this._value_('composeMessage', this.composeMailDefault) }
