...
import {
  STREAM_WINDOW_TOGGLE_SIDEBAR,
  STREAM_WINDOW_TOGGLE_APP_MENU,
  QUIT_APP
...
ipcRenderer.on(STREAM_WINDOW_TOGGLE_SIDEBAR, actions.toggleSidebar)
ipcRenderer.on(STREAM_WINDOW_TOGGLE_APP_MENU, actions.toggleAppMenu)
